...
function calculate()
{
	global $pagination_title;

	$this->pagination = "";

	$this->pagination.= "<span class='num'>".$pagination_title['Total'].":<strong>&nbsp;&nbsp;".ceil($this->total_pages/18)."&nbsp;&nbsp;</strong>".$pagination_title['Page']."</span> ";
	...
	$n = $pagination_title['Next'];
	
	//$p = trim($this->prevI.' '.$this->prevT);
	
	$p = $pagination_title['Back'];
		...
		{//enough pages to hide some
			...
			if($this->page)
			{
				...
				if($this->showCounter)
					...
					$this->pagination .= "<div class=\"pagination_data\">(".$this->total_pages."  ".$pagination_title['item'].")</div>";
			}
		}
