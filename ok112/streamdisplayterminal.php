...
else
{
	...
	$sql.= "AND terminal.id IN(SELECT terminalid FROM terminalofgroup WHERE groupid = '$streamid') ORDER BY CONVERT(terminal.terminalname USING utf8)";
...
*/
	...
	$smarty->display("StreamManager/streamdisplayterminal.html");
}
?>