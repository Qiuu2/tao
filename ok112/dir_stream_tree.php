...
//判断是系统管理员
$result_folder = get_area_dir_info('0',$terminal_id);
$faname = chinese_big5_english($_SESSION['language'],'目录管理');
$str_js = "<html xmlns=\"http://www.w3.org/1999/xhtml\"><head><meta http-equiv=\"content-type\" content=\"text/html; charset=utf-8\"/>
			...
			$folder = get_area_dir_info('-1',$terminal_id);
			while($rowfolder = mysqli_fetch_array($folder))
			{
				$str_js.="<span class=\"folder\">&nbsp;&nbsp; <a href=\"dir_terminal_area.php?id=".$rowfolder['id']."&terminal_id=".$terminal_id."\"  target=\"dirarea\" >".$faname."</a></span>";
			}
		...
		while($row_folder = mysqli_fetch_array($result_folder))
		{
		   ...
		   $str_js.="<ul class=\"filetree\">
					   ...
					   <span class=\"folder\">
						  ...
						  <a href=\"dir_terminal_area.php?id=".$row_folder['id']."&terminal_id=".$terminal_id."\"  target=\"dirarea\" >".$faname."</a>
						
					   </span>";
						
		             $result_1folder = get_area_dir_info($row_folder['id'],$terminal_id);
					 while($row_1folder = mysqli_fetch_array($result_1folder))
					 {
						$str_js.= "<ul id=\"\" class=\"filetree\">
								      ...
								      <span class=\"folder\">
										   ...
										   <a href=\"dir_terminal_area.php?id=".$row_1folder['id']."&terminal_id=".$terminal_id."\" target=\"dirarea\">".
										   
										   chinese_big5_english($_SESSION['language'],$row_1folder['name'])."</a>
								      </span>";
						
								      $result_2folder = get_area_dir_info($row_1folder['id'],$terminal_id);
						              ...
						              while($row_2folder = mysqli_fetch_array($result_2folder))
						              {
										  ...
										  <a href=\"dir_terminal_area.php?id=".$row_2folder['id']."&terminal_id=".$terminal_id."\"  target=\"dirarea\">".chinese_big5_english
