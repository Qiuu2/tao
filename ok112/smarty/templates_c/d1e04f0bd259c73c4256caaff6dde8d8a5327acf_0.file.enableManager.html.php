...
/* Smarty version 3.1.30, created on 2026-07-06 15:53:29
  from "/var/www/html/ok112/smarty/templates/holidaymanager/enableManager.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6a4b5ef9431c01_12023641',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd1e04f0bd259c73c4256caaff6dde8d8a5327acf' => 
    array (
      0 => '/var/www/html/ok112/smarty/templates/holidaymanager/enableManager.html',
      1 => 1778116071,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:holidaymanager/enableManager_form.html' => 1,
    'file:language/".((string)$_smarty_tpl->tpl_vars[\'language\']->value)."_foot.php' => 1,
  ),
),false)) {
function content_6a4b5ef9431c01_12023641 (Smarty_Internal_Template $_smarty_tpl) {
...
function enableholiday()
{
	...
	{
		alert("<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['bell_manager']->value['select_holiday']);?>
");
		return void(0);
	}
	else
	{
		...
		location="do.php?act=enableholiday&id="+getItem+"";
	}
}
...
");
	...
	else
	{
		...
		location="do.php?act=disableholiday&id="+getItem+"";
	}
}
...
");
	...
	if(getItem==null||getItem=="")
	{
		alert("<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['bell_manager']->value['select_task']);?>
");
		return void(0);
	}
	else
	{
		location="enablemodify.php?id="+getItem+"";
	}
}
...
"))
		{
			location="do.php?act=delenable&id="+getItem+"";
		}
		else
		{
			return void(0);
...
<?php $_smarty_tpl->_subTemplateRender("file:holidaymanager/enableManager_form.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
