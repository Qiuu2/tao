<?php
/* Smarty version 3.1.30, created on 2026-07-06 15:50:49
  from "/var/www/html/ok112/smarty/templates/BellManager/modifybell.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6a4b5e59109259_55368502',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5f23a4246ab00c486d1ade2a3774afa7856003c1' => 
    array (
      0 => '/var/www/html/ok112/smarty/templates/BellManager/modifybell.html',
      1 => 1778116057,
      2 => 'file',
    ),
  ),
...
function content_6a4b5e59109259_55368502 (Smarty_Internal_Template $_smarty_tpl) {
...
var _get_row;
var get_timelength;
function Playlenthselect(tt) 
{
	_fieldname = tt;
	_get_row = tt.parentNode.parentNode.rowIndex;
	...
	document.all._lenthcontents.style.top = ttop + thei + 4-document.getElementById( "divTest").scrollTop;
	document.all._lenthcontents.style.left = tleft;
	document.all._contents.style.visibility = "hidden";
...
{ 
    if(document.all.radio[0].checked)
    {
        ...
        _fieldname.value = document.all._hourlen.value + ":" + document.all._minutelen.value + ":" + document.all._secondlen.value;
		if(_get_row==1)
		{
			document.getElementById('bell_playlen').innerHTML="<font class='terminal_star'>"+_fieldname.value+"</font>";
			document.getElementById('bell_playlen').style.display = "none";
	
		}
		else
		{
			document.getElementsByName('bell_playlen')[_get_row-1].innerHTML="<font class='terminal_star'>"+_fieldname.value+"</font>";
			
			document.getElementsByName('bell_playlen')[_get_row-1].style.display = "none";

		}
    }
    else if(document.all.radio[1].checked)
    {
        _fieldname.value = document.all._times.value;
		if(_get_row==1)
			{
	
			var get_temptime=document.getElementById('bell_playlen').value;

		var counttimes = get_temptime.split(":");
			var temptimes = (parseInt(counttimes[0])*60*60 + parseInt(counttimes[1])*60 + parseInt(counttimes[2]));
			getlen=time_tran_format(parseInt(_fieldname.value)*parseInt(temptimes));
			...
			{
				var get_temptime=document.getElementsByName('bell_playlen')[_get_row-1].value;

			var counttimes = get_temptime.split(":");
			var temptimes = (parseInt(counttimes[0])*60*60 + parseInt(counttimes[1])*60 + parseInt(counttimes[2]));
	
			getlen=time_tran_format(parseInt(_fieldname.value)*parseInt(temptimes));
			document.getElementsByName('bell_playlen')[_get_row-1].innerHTML="<font class='terminal_star'>"+getlen+"</font>";
			document.getElementsByName('bell_playlen')[_get_row-1].style.display = "";
		}
    }
...
<?php echo '<script'; ?>
 language="javascript">
var getlen;
function getinsertrowtimelength(row,timelength)
{
	if(getcopyrow==1)
	{	
		getcopyrow=0;
	...
	if(row==1)
	{
		getlen=time_tran_format(parseInt(document.getElementById('belltiemlength').value)*timelength);
		document.getElementById('bell_playlen').innerHTML="<font class='terminal_star'>"+getlen+"</font>";
		document.getElementById('bell_playlen').value=getlen;
	}
	else
	{
		getlen=time_tran_format(parseInt(document.getElementsByName('belltiemlength')[row-1].value)*timelength);
		document.getElementsByName('bell_playlen')[row-1].innerHTML="<font class='terminal_star'>"+getlen+"</font>";
		document.getElementsByName('bell_playlen')[row-1].value=getlen;
	}
}
...
function get_time_disable(obj)
{

	_get_row = obj.parentNode.parentNode.rowIndex;
	if(_get_row==1)
		{
		...
		{
			document.getElementsByName('bell_playlen')[_get_row-1].innerHTML="<font class='terminal_star'>"+document.getElementsByName('belltiemlength')[_get_row-1].value+"</font>";
			document.getElementsByName('bell_playlen')[_get_row-1].value=document.getElementsByName('belltiemlength')[_get_row-1].value;
			document.getElementsByName('bell_playlen')[_get_row-1].style.display = "none";
		}
...
var row=1;//产生序号
var sign=0;//判断单击次数
function insertRowInTable(gettable,getrows)
{
...
\" type=\"radio\" name=\"belltaskid\" id=\"belltaskid\" value=\"-1\"  onclick=\"getonebelltaskterminal(this)\"/>";
...
\" type=\"text\" name=\"coursename\" id=\"coursename\" maxlength=\"12\" /><span class=\"terminal_star\" id=\"coursename_text\" name=\"coursename_text\">*</span>";
...
\" type='text' value='00:00:00' name='bellstarttime'  id='bellstarttime' readonly='true' size='10' onclick='Timeselect(this)'/>";
	newRow.insertCell(3).innerHTML = "<select title=\"<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['select_musictask']);?>
\" name=\"setbellname\" id=\"setbellname\" style=\"width:150px\" onchange=\"get_media_time_length(this);get_time_disable(this);\"><?php
...
\"><?php echo $_smarty_tpl->tpl_vars['medialist']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_medialist']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_medialist']->value['index'] : null)]['name'];?>
</option><?php
}
}
...
\" type='text' value='01'  style=\"width:60px\" name='belltiemlength' id='belltiemlength' readonly='true' size='10' onclick='Playlenthselect(this)'/><span class=\"terminal_star\" id=\"bell_playlen\" name=\"bell_playlen\"></span>";
...
\" id=\"delrow\" name=\"delrow\" onclick=\"deleteRow(this);\">&nbsp;<input  type=\"button\" style=\"font-family: Arial, Helvetica, sans-serif;font-size: 12px;color: #3366cc;border: 1px solid #336699;\"  value=\"<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['copy_item']);?>
\" id=\"copyrow\" name=\"copyrow\" onclick=\"copyRow(this);\">";
	getinsertrowtimelength(row,<?php echo $_smarty_tpl->tpl_vars['mediatimelength']->value;?>
);
	if(row==1)
	{
		document.getElementById('coursename').value="<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['Task_name']);?>
"+row;
	}
	else
	{
		document.getElementsByName('coursename')[row-1].value="<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['Task_name']);?>
"+row;
	}
	  row++;
	  sign++;
	 ...
	 if(getrows>0)
	{
		var obj = document.getElementsByName('setbellname')[row-2];
		
		for(var i=0;i<obj.options.length;i++)
		{
			if(obj.options[i].value == document.getElementsByName('setbellname')[getrows-1].value)
			{
		...
		document.getElementsByName('bellstarttime')[row-2].value=document.getElementsByName('bellstarttime')[getrows-1].value;
		var playlen=document.getElementsByName('belltiemlength')[getrows-1].value;
		
		if(playlen.length>3)
		{
			document.getElementsByName('belltiemlength')[row-2].value=document.getElementsByName('belltiemlength')[getrows-1].value;
			document.all.radio[0].checked=1;
		}
		else
		{
			document.getElementsByName('belltiemlength')[row-2].value=document.getElementsByName('belltiemlength')[getrows-1].value;
			document.all.radio[1].checked=1;
		}
	}
}
...
function copyRow(r)
{
	//getonebelltaskterminal(r);
	var i=r.parentNode.parentNode.rowIndex;
	/*if(i==1)
	{
		var obj=document.getElementById('belltaskid');	
	}
	else
	{
		var obj=document.getElementsByName('belltaskid')[i-1];	
	}
	
	getonebelltaskterminal(obj);*/
	getcopyrow=1;
	insertRowInTable('coursetable',i);
...
function getcurrentrowindex(obj)
{
	...
	else if(totalrownum >1)
	{
		...
		getonebellname = document.getElementsByName('setbellname')[getcurrentrownum-1].value;
	
		var getonetimelengthtemp = document.getElementsByName('belltiemlength')[getcurrentrownum-1].value;
		//getonetimelength = getonetimelengthtemp[0]*60*60 + getonetimelengthtemp[1]*60 + getonetimelengthtemp[2]*1;
...
");
		...
		if(getnewtaskid == 1)
		{
			if(totalrownum == 1)
			{
				...
				document.getElementById('bellstarttime').disabled = true;
				document.getElementById('setbellname').disabled = true;
				document.getElementById('belltiemlength').disabled = true;
				document.getElementById('add').disabled = true;	
				document.getElementById('belltaskid').checked = false;
			}
			else if(totalrownum >1)
			{
				document.getElementsByName('coursename')[getcurrentrownum-1].disabled = true;
				document.getElementsByName('bellstarttime')[getcurrentrownum-1].disabled = true;
				document.getElementsByName('setbellname')[getcurrentrownum-1].disabled = true;
				document.getElementsByName('belltiemlength')[getcurrentrownum-1].disabled = true;
				document.getElementsByName('add')[getcurrentrownum-1].disabled = true;	
				document.getElementsByName('belltaskid')[getcurrentrownum-1].checked = false;	
			}
		}
		if(getnewtaskid > 1)
		{
...
function getonebelltaskterminal(obj)
{
	...
	if(totalrownum == 1)
	{
		if(document.getElementById('add').className > 0)
		{
			document.getElementById('coursename').disabled  =  false;
			document.getElementById('bellstarttime').disabled = false;
			document.getElementById('setbellname').disabled = false;
			document.getElementById('belltiemlength').disabled = false;
	...
	else if (totalrownum > 1)
	{
		...
		{
			if(document.getElementsByName('add')[i].className > 0)
			{
				document.getElementsByName('coursename')[i].disabled = true;
				document.getElementsByName('bellstarttime')[i].disabled = true;
				document.getElementsByName('setbellname')[i].disabled = true;
				document.getElementsByName('belltiemlength')[i].disabled = true;
				document.getElementsByName('add')[i].disabled = true;
			}
		}
		if(document.getElementsByName('add')[getcurrenrownum-1].className > 0)
		{
...
");
	...
	if(sign>1)
	{
		...
		{
			if(document.getElementsByName('add')[i].className==1)
			{
				countnum++;
				if(countnum >= document.getElementsByName('coursename').length)
				{
					alert("<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['add_task_bell_scheme']);?>
");
					submitcount=0;
...
');
	...
	else if(sign >1)
	{
		...
		for(var i=0;i<document.getElementsByName('bellstarttime').length;i++)
		{
			...
			{
				countnum++;
				if(countnum >= document.getElementsByName('bellstarttime').length)
				{
					alert('<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['add_task_bell_scheme']);?>
');
					submitcount=0;
			...
			else
			{
				if(getbelltime=="" || getsetbellname=="" || getbelltimelength=="" || getbelltaskid=="")
				{
					...
					getsetbellname = trim(document.getElementsByName('setbellname')[i].value);
					
					var counttime = document.getElementsByName('belltiemlength')[i].value;
					//var temptime = (counttime[0]*60*60 + counttime[1]*60 + counttime[2]*1);
					getbelltimelength = counttime;
	...
	document.getElementById('hiddenbelltaskid').value = getbelltaskid;

	
	//alert(document.getElementById('hiddenbelltaskid').value);
...
function displayonetaskterminal(strterminal,getcurrenrownum)
{
	...
	if(getterminalid == "")
	{
		if(tree3 != null)
		{
			...
			tree3.setOnClickHandler(clickcheck);
...
<form class="terminal_form_to_body" name="bellform" method="post" action="do.php?act=belltaskalonemodify&taskid=<?php echo $_smarty_tpl->tpl_vars['taskid']->value;?>
" onSubmit="return checkform();">
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="terminal_table_border">
  
    <tr>
      <td colspan="2">
	  	<img src="<?php echo $_smarty_tpl->tpl_vars['modify_bell_scheme']->value['modify_bell_image'];?>
"/>
	  </td>
    </tr>
...
" type="button" class="bell_button_style" onClick="insertRowInTable('coursetable',0)" id="addrow" name="addrow" value="<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['Add_Task']);?>
"/>
				</td>
			</tr>
...
>
	...
	{
	var getlevel=<?php echo $_smarty_tpl->tpl_vars['getlevel']->value;?>
+level;
...
/10);
	...
	*/
	var level2=0;
	for(level2=<?php echo $_smarty_tpl->tpl_vars['getlevel']->value;?>
;level2<=109;level2++)
	{
		document.write("<option value='"+level2+"'>"+level2+"</option>");
	}			
...
" class="terminal_select_style" name="exemodel" id="exemodel" onChange="displayweek(this)">
 ...
 language="javascript" defer="true">
				var objs = document.getElementById('exemodel');
				for(var i=0;i<objs.options.length;i++)
				{
					if(objs.options[i].value == 2)
					{
...
<tr>
	...
	<table class="bell_sub_table">
		<tr class="bell_sub_table_row">
			...
			<td width="20%" nowrap="nowrap"><?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['Lesson_name']);?>
</td>
			<td width="15%" nowrap="nowrap"><?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['Bell_time']);?>
</td>
			<td width="18%" nowrap="nowrap"><?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['Bell_music']);?>
</td>
			<td width="15%" nowrap="nowrap"><?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['Duration']);?>
</td>
			<td width="17%" nowrap="nowrap"><?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['modify_bell_scheme']->value['Compile']);?>
</td>
		</tr>
	</table>
	</td>
...
<tr>
	...
	<table id="coursetable" name="coursetable" class="bell_sub_table">
		<tr >
			...
			<td width="20%"  height="1" nowrap="nowrap" align="center"></td>
			<td width="15%"  height="1" nowrap="nowrap" align="center"></td>
			<td width="18%"  height="1" nowrap="nowrap" align="center"></td>
			<td width="15%"  height="1" nowrap="nowrap" align="center"></td>
			<td width="17%"  height="1" nowrap="nowrap" align="center"></td>
		</tr>
	</table>
	</div>
	</td>
...
");
				...
				if(state == 1)
				 ...
				 {
				  	display();
					//var urls = "get_terminalarea.php?id="+document.getElementById('get_belltaskid').value+"";
					
					//getchannelvalue(urls);
...
");
		...
		tree3.enableThreeStateCheckboxes(true);
		 tree3.setOnCheckHandler(toncheck);
		 tree3.setOnClickHandler(clickcheck);
		 /*tree3.setOnClickHandler(function(id){
    		//var i=tree3.getSelectedItemId();
			//toncheck(i,1);
  		});*/
...
echo '<script'; ?>
 language="javascript">
	insertRowInTable("coursetable",0);
...
";
	var obj = document.getElementsByName('setbellname')[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index'] : null);?>
];
	//var getsetmedianame="addmediainfo.php?flag=4&id="+<?php echo $_smarty_tpl->tpl_vars['lessoninfo']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index'] : null)]['mediaid'];?>
+"";
...
==1)
	{
		document.getElementsByName('belltiemlength')[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index'] : null);?>
	...
	else
	{
		...
		document.getElementsByName('belltiemlength')[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index'] : null);?>
].value = parseInt(<?php echo $_smarty_tpl->tpl_vars['lessoninfo']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index'] : null)]['timelength'];?>
);
		document.getElementsByName('bell_playlen')[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index'] : null);?>
...
*<?php echo $_smarty_tpl->tpl_vars['lessoninfo']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index'] : null)]['timelength'];?>
		...
		document.getElementsByName('setbellname')[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index'] : null);?>
].disabled = true;
		document.getElementsByName('coursename')[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index'] : null);?>
].disabled = true;
		document.getElementsByName('bellstarttime')[<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_lesson']->value['index'] : null);?>
