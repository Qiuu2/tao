...
/* Smarty version 3.1.30, created on 2026-05-26 12:40:39
  from "/var/www/html/ok112/smarty/templates/ledmanager/ledTaskManager.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6a152447ba2243_58688864',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e55497d291c0c7ffcabbc65e8ba4ae65ca0172a8' => 
    array (
      0 => '/var/www/html/ok112/smarty/templates/ledmanager/ledTaskManager.html',
      1 => 1778116078,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:ledmanager/ledTaskManager_from.html' => 1,
    'file:language/".((string)$_smarty_tpl->tpl_vars[\'language\']->value)."_foot.php' => 1,
  ),
),false)) {
function content_6a152447ba2243_58688864 (Smarty_Internal_Template $_smarty_tpl) {
...
");
	...
	{
		location="do.php?act=ledtaskstart_msg&id="+qstr+"&gettask="+gettask+"&userid="+userid+"";
	}	
}
...
"))
		...
		{
			location="do.php?act=ledtaskstop_msg&id="+qstr+"&gettask="+gettask+"&userid="+userid+"";
		}
	}
}
...
");
	...
	{
		window.location.href = "ledtaskmodify.php?id="+getid+"&gettask="+gettask+"&userid="+userid+"";
	}
}
function delTask()
{
...
"))
		...
		{
				window.location.href = "do.php?act=ledtaskdel_msg&id="+qstr+"&gettask="+gettask+"&userid="+userid+"";
		}
	}
}
//获得选中文件的文件名
...
function ajax_set_task_copy(taskcopyfrom,taskcopyto)
{
   ...
   xmlhttp.open( "get","set_led_copy.php?taskcopyfrom="+taskcopyfrom+"&taskcopyto="+taskcopyto+"",true );
...
function set_task_volume()
{
	...
	ajax_set_task_volume("24",volume_value,task_id);
}
...
"))
		...
		{
		location="do.php?act=led_start_task_msg&id="+getid+"&taskid="+taskid+"&userid="+userid+"";
		}
	}	
}
/*****************
...
"))
		...
		{
		location = "do.php?act=led_stop_task_msg&id="+getid+"&taskid="+taskid+"&userid="+userid+"";
		}
	}
}
...
";
	...
	if(sign == 1)
	{
		window.location.href="filefolderdo.php?sign=ledadd&id="+get_folder_id+"&userid="+userid+"";
	}
	else if(sign==200)
	{
		window.location.href="filefolderdo.php?sign=ledadd&id="+get_folder_id+"&userid="+userid+"";
...
"))
	...
	{
		location="do.php?act=ledfolderdel_msg&id="+get_folder_id+"";
	}
}

function modifyfolder(obj,get_folder_id)
{
	window.location.href="filefolderdo.php?sign=ledmodify&id="+get_folder_id+"";	
}
function sortTables(col, dataType)
{
	window.location.href="ledtaskmanager.php?col="+col+"&dataType="+dataType+"&id="+<?php echo $_smarty_tpl->tpl_vars['get_task_id']->value;?>
...
<?php $_smarty_tpl->_subTemplateRender("file:ledmanager/ledTaskManager_from.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
