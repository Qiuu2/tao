...
<title><?php echo strtoupper($operate_prompt['Failed']); ?></title>
...
<table width="400" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#E8E8E8"   style="margin-top:50px;border:#7E98C0 solid 1px;">
  <tr>
    <td background="images/xxbg.jpg" style="border-bottom:#7E98C0 solid 1px;">
		<?php echo strtoupper($operate_prompt['Note']); ?>
	</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			 <td height="50" align="center">
			 	<img src="skin/images/frame/error.jpg" width="32" height="35" align="absmiddle">
			 	<?=$_SESSION['info']?>
			 </td>
			</tr>
			<tr>
				<td height="20" align="center">
					...
					?>
						...
						<A href="login.php" target="_self"><?php echo strtoupper($operate_prompt['Click_here']); ?></A>
					<?php
						}
						else
						{
					?>
						<A href="<?=$_SESSION['url']?>"><?php echo strtoupper($operate_prompt['Click_here']); ?></A>
					<?
						}
					?>
					</p>
