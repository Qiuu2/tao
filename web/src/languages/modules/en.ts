...
export default {
  ...
  dash: {
    ...
    runningTip: "The backend service has this task in hand right now (task.state = {s}: 1 running / 2 paused / 3 play now)",
  ...
  bell: {
    ...
    termScopePlan: "Showing the whole plan’s terminal list. “OK” below applies it to every lesson.",
    termScopeItem:
      "Showing lesson {n} “{name}”’s own terminals ({c}). Hit “Modify” on that row to save just this lesson; “OK” below applies the list to every lesson.",
    termScopeNewItem:
      "Lesson {n} is not stored yet, so the whole plan’s terminal list is shown. “Add” on that row stores the current selection for it.",
    termOfLesson: "{c} for this lesson",
    backToPlanTerminals: "Back to the plan’s terminals",
