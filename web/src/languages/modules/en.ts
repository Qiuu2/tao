...
export default {
  ...
  dash: {
    ...
    onToday: "On today",
    offToday: "Off today",
    pickTasksFirst: "Select at least one task first",
    dayActsOn: "Applies to {d} (follows the weekday picker above)",
    offDayConfirm: "Skip the {n} selected task(s) on {d}? They stay silent that day and run normally on every other day.",
    onDayConfirm: "Clear the single-day skip on the {n} selected task(s)? They will run normally on {d}.",
    offDayDone: "{n} task(s) set to skip {d} ({s} sub-task(s) followed)",
    onDayDone: "Single-day skip cleared on {n} task(s) ({s} sub-task(s) followed)",
    daySkipped: "{n} could not be changed: gone, or not yours",
    filterFolder: "Folder:",
    filterModule: "Module:",
    filterWeekday: "Weekday:",
    filterType: "Task type:",
    viewingDate: "Showing {d}",
    done: "Done",
    running: "Running",
    paused: "Paused",
    playNow: "Play now",
    ...
    runningTip: "Live state reported by the backend service: task.state = {s}",
    disableDay: "Skipped on",
    onDateTip: "This task runs on {d}",
    offDateTip: "This task does not run on {d}",
    modBell: "Bell plans",
    modFile: "File broadcast",
    modAmplifier: "Amplifier",
    modCollect: "Live capture",
  ...
  term: {
    ...
    confirmRenumber:
      "Change the ID of “{name}” from {from} to {to}? If the target ID is already taken, that record is deleted — no model check, and an online target is deleted too.",
    ...
    targetIdTakenNote:
      "If the target ID is already taken, that record is deleted and this terminal takes over its tasks, zones and key bindings. No model check, and an online target is replaced too.",
    ...
    nTargetsDeleted: "{n} deleted",
    targetsOfKey: "Mapped terminals · {name} ({key})",
    keyAreaMask: "Areas",
    allAreas: "All areas",
    noArea: "No area enabled",
    shortcutKey: "Shortcut key",
    viewList: "List view",
    viewGrid: "Grid view",
    gridPicked: "{n} selected · {total} on this page",
  ...
  mapView: {
    ...
    pickerNoteHere: "The terminals you pick land where you right-clicked",
    allPlaced: "Every available terminal is already on this map.",
    dragHint:
      "Right-click an empty spot to add terminals there — they land exactly where you clicked. Right-click a terminal to take it off the map. Drag a terminal to fine-tune its position.",
    addHere: "Add terminals here",
    removeHere: "Take this one off the map",
    ctxRefresh: "Refresh this map",
    placedHere: "Placed where you right-clicked",
    needTables: "The two map tables have not been created yet",
    needTablesTip:
      "htweb's database account has no DDL rights (that is what lets it coexist with the legacy system). Ask an admin to run the command below once with a DDL-capable account, then hit Reload.",
    retryAfterSql: "Reload",
    legend: "Legend",
    stOffline: "Offline",
    stIdle: "Idle",
    stPlaying: "Playing",
  ...
  media: {
    ...
    egMp3Wav: "e.g. mp3 / wav / flac / m4a / aac",
    bitrate: "Bitrate",
    mediaType: "Type",
    ...
    noFilePicked: "No media file picked yet — use “Add media” below.",
    ...
    uploadLimit:
      "mp3, wav, flac, m4a and aac, up to 300 MB per file. The format is detected from the file header, not the extension.",
  ...
  bell: {
    ...
    planNameTooLong: "The plan name can be at most {n} characters",
    ...
    multiToneTag: "was {n}",
    multiToneTip: "This lesson used to have {n} tones. A lesson can only have one — saving keeps just the one selected above.",
    multiToneWarn: "{n} lesson(s) used to have more than one tone. A lesson can only have one — saving keeps the first of each.",
    ...
    deleteNPlans: "This permanently deletes everything in the following {n} plan(s):",
    sameNameOthers: "{n} other task(s) share a name with the plans being deleted but do not belong to them.",
    volumeChangedN: "Volume of {plans} plans set to {vol}; {n} task(s) affected",
  ...
  rights: {
    ...
    groupTask: "Tasks",
    groupCloud: "Cloud broadcast",
    groupNoise: "Noise monitoring",
    groupSystem: "System",
    terminal: "Terminal management",
    terminalTip:
      "Every write action on the Terminals page: settings, volume, start/stop, password, power, shortcut keys, paging groups, quick tasks, terminal replacement, deletion. Also Time settings → push time sync.",
    zone: "Terminal zones",
    zoneTip: "Create, edit and delete terminal zones",
    ...
    map: "Map",
    mapTip: "Create / rename / delete maps, change the base image, and place terminals on it",
    task: "File broadcast",
    ...
    tts: "Text to speech",
    ttsTip: "Create / edit / delete / start / stop text-to-speech tasks",
    led: "LED display",
    ledTip: "Create / edit / delete / start / stop LED display tasks, plus LED task folders and LED devices",
    enable: "Activation",
    enableTip: "Create / edit / delete activation plans",
    cloudTerminal: "Cloud terminals",
    cloudTerminalTip:
      "The button row on the Cloud terminals page: idle / immediate transfer, stop, idle / immediate delete, clear everything, clear terminal media and idle media",
    offline: "Music transfer",
    offlineTip: "Push media and tasks to cloud broadcast terminals, and stop transfers",
    transfer: "Task transfer",
    transferTip:
      "Idle / immediate transfer of server tasks; transfer, delete, stop, offline playback and delete-offline-files for cloud tasks",
    noiseDevice: "Noise devices",
    noiseDeviceTip: "Create / edit / delete noise probes",
    soundZone: "Sound-field zones",
    soundZoneTip: "Create / edit / delete sound-field zones (this changes which sound-field zone a terminal belongs to)",
    soundTask: "Sound-field tasks",
    soundTaskTip: "Create / edit / delete / start / stop sound-field tasks, and the default noise-level template",
    remote: "Remote control",
    remoteTip: "Remote tasks. Also Basic settings → Server info and the NTP / GPS parts of Time settings; Users → Licensing.",
    user: "User management",
    userTip: "View and maintain users and user groups; issue / disable / delete developer keys",
    api: "API console",
    apiTip: 'The developer API reference and its "try it" page (it cannot change anything by itself)'
  },
  enable: {
    expired: "Expired",
  ...
  login: {
    ...
    slideToVerify: "Hold the slider and drag it all the way right",
    slideVerified: "Verified",
    slideFirst: "Drag the slider to verify first",
