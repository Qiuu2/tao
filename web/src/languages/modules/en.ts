...
export default {
  ...
  mapView: {
    ...
    needTablesTip: "htweb's database account has no DDL rights (that is what lets it coexist with the legacy system). Ask an admin to run the command below once with a DDL-capable account, then hit Reload.",
